...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        String PACKAGE_NAME = "laioffer.com.onlineOrder.entity";
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "onlineorder-instance.csskcp266w1x.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "Lkw729800";
